...
- JWT authentication for the admin API with role-based access control.
...
- Document uploads enforce allowed extensions, MIME types, size limits, duplicate checksum detection, and optional ClamAV scanning.
...
- Enable Sentry and Prometheus metrics.
